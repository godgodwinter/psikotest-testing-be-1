...
Route::post('/testing/apiprobk/store ', [adminApiprobkController::class, 'store'])->name('testing.apiprobk.store');
Route::get('/testing/apiprobk/all', [adminApiprobkController::class, 'all'])->name('testing.apiprobk.all');
Route::post('/testing/apiprobk/upload', [adminApiprobkController::class, 'upload'])->name('testing.apiprobk.upload');

Route::post('/testing/apiprobk/api_backup ', [adminApiprobkController::class, 'api_backup'])->name('testing.apiprobk.api_backup');
Route::post('/testing/apiprobk/api_backup_deteksi ', [adminApiprobkController::class, 'api_backup_deteksi'])->name('testing.apiprobk.api_backup_deteksi');

Route::post('/testing/apiprobk/gagal ', [adminApiprobkController::class, 'gagal'])->name('testing.apiprobk.gagal');

Route::post('/testing/apiprobk/reset ', [adminApiprobkController::class, 'reset'])->name('testing.apiprobk.reset');
